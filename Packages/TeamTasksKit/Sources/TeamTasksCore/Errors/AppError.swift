...
public enum AppError: Error, Sendable, Hashable {
    ...
    public var messageFR: String {
        ...
        case .lastAdmin: "Vous êtes le dernier administrateur : nommez d'abord un autre administrateur."
        case .notMember: "Cette personne ne fait pas partie du groupe."
        case .cannotRemoveSelf: "Utilisez « Quitter le groupe » pour vous retirer vous-même."
